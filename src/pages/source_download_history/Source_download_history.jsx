...
export default function Source_download_historyPage() {
    const fieldsType = {
        id: "INTEGER",
        file_name: "STRING",
        subject_id: "INTEGER",
    ...
    const [onChangeColumns] = useColumns(columns, setColumns, "source_download_history");
    ...
    const getData = () => {
        ...
        Request.source_download_history
            .get(query)
            .then(({ data }) => {
